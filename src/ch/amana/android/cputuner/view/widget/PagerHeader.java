...
public class PagerHeader extends ViewGroup {
	...
	private final ShapeDrawable mTabDrawable;
	private final ShapeDrawable mBottomBar;
	private final GradientDrawable mShadow;
	private final GradientDrawable mFadingEdgeLeft;
	private final GradientDrawable mFadingEdgeRight;

	private OnHeaderClickListener mOnHeaderClickListener = null;

	private boolean mChangeOnClick = true;

	private final ColorSet mActiveTextColor;
	private final ColorSet mInactiveTextColor;
	private final ColorSet mTabColor;
	private final int mTabHeight;
	private final int mTabPadding;
	private final int mPaddingPush;
	private final int mFadingEdgeLength;
	private final int mShadowHeight;
	private final int mBottomBarHeight;
	private final boolean mShowTopShadow;
	private final boolean mShowBottomBar;
