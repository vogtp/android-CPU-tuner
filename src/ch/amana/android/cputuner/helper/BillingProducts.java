...
public class BillingProducts {
	...
	public static Product[] getProducts(final Context ctx, final int type, final BillingManager bm) {
		switch (type) {
	...
	public static Product[] getExtentions(final Context ctx, final BillingManager bm) {
	...
	public static Product[] getBuyBeer(final Context ctx, final BillingManager bm) {
	...
	private static void getPoductsCount(final BillingManager bm, final Product[] products) {
